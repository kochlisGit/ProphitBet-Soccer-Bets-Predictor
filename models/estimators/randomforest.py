...
class RandomForest(ScikitModel):
    def __init__(
            ...
            max_features: str or None = 'sqrt',
            max_depth: int or None = None,
            class_weight: str or None = None,
            calibrate_probabilities: bool = False,
            **kwargs
    ):
        assert 0 < n_estimators, f'n_estimators should be positive, got {n_estimators}'
    ...
    def _build_estimator(self, input_size: int, num_classes: int) -> RandomForestClassifier:
