...
class CustomTrainDialog(Dialog, ABC):
    def __init__(
        ...
        self._train_btn = Button(
            self.window, text="Train", command=self._submit_training
        )
    ...
    def _train_fn(self, use_over_sampling: bool, num_eval_samples: int):
        ...
        if validation_result == "valid":
            ...
            task_thread = threading.Thread(
                target=self._train,
                args=(task_dialog, use_over_sampling, num_eval_samples),
            )
            task_thread.start()
            task_dialog.open()
        else:
    ...
    def _train(
        self, task_dialog: TaskDialog, use_over_sampling: bool, num_eval_samples: int
    ):
        self._build_model()
...
class TrainCustomNNDialog(CustomTrainDialog):
    ...
    def _initialize(self):
        ...
        Label(self.window, text="Early Stopping Patience", font=("Arial", 10)).place(
            x=20, y=115
        )
        Label(self.window, text="Learning Rate Decay Rate", font=("Arial", 10)).place(
            x=20, y=165
        )
        Label(
            self.window, text="Learning Rate Decay Patience", font=("Arial", 10)
        ).place(x=20, y=215)
        Label(self.window, text="Learning Rate", font=("Arial", 10)).place(x=20, y=265)
        Label(self.window, text="Input Noise Range", font=("Arial", 10)).place(
            x=20, y=315
        )
        Label(self.window, text="Hidden Layers", font=("Arial", 10)).place(x=20, y=365)
        Label(self.window, text="Hidden Layer Activations", font=("Arial", 10)).place(
            x=20, y=415
        )
        Label(
            self.window, text="Hidden Layer Batch Normalizations", font=("Arial", 10)
        ).place(x=20, y=465)
        Label(
            self.window, text="Hidden Layer Regularizations", font=("Arial", 10)
        ).place(x=20, y=515)
        Label(self.window, text="Hidden Layer Dropout Rates", font=("Arial", 10)).place(
            x=20, y=565
        )
        Label(self.window, text="Optimizer", font=("Arial", 10)).place(x=20, y=615)
        Label(self.window, text="Use Input Over-Sampling", font=("Arial", 10)).place(
            x=20, y=665
        )
        Label(self.window, text="Evaluation Samples", font=("Arial", 10)).place(
            x=20, y=715
        )
        ...
        batch_size_cb = Combobox(
            ...
            textvariable=self._batch_size_var,
        )
        ...
        Scale(
            ...
            orient="horizontal",
            length=150,
            variable=self._early_stopping_epochs_var,
        ).place(x=300, y=100)
        ...
        Entry(
            ...
            textvariable=self._learning_rate_decay_factor_var,
        ).place(x=300, y=165)
        ...
        Scale(
            ...
            orient="horizontal",
            length=100,
            variable=self._learning_rate_decay_epochs_var,
        ).place(x=300, y=200)
        ...
        Entry(
            ...
            validate="key",
            validatecommand=(validate_float, "%P"),
            textvariable=self._learning_rate_var,
        ).place(x=300, y=265)
        ...
        Entry(
            ...
            validate="key",
            validatecommand=(validate_float, "%P"),
            textvariable=self._noise_range_var,
        ).place(x=300, y=315)
        ...
        Entry(
            ...
            width=20,
            font=("Arial", 10),
            textvariable=self._hidden_layers_var,
        ).place(x=300, y=365)
        ...
        Entry(
            ...
            width=20,
            font=("Arial", 10),
            textvariable=self._activations_var,
        ).place(x=300, y=415)
        ...
        Entry(
            ...
            width=20,
            font=("Arial", 10),
            textvariable=self._batch_normalizations_var,
        ).place(x=300, y=465)
        ...
        Entry(
            ...
            width=20,
            font=("Arial", 10),
            textvariable=self._regularizations_var,
        ).place(x=300, y=515)
        ...
        optimizer_size_cb = Combobox(
            ...
            font=("Arial", 10),
            state="readonly",
            textvariable=self._optimizer_var,
        )
        ...
        Scale(
            ...
            orient="horizontal",
            length=220,
            variable=self.num_eval_samples_var,
        ).place(x=300, y=700)
    ...
    def _validate_form(self) -> str:
        ...
        try:
            hidden_layers_eval = ast.literal_eval(
                self._hidden_layers_var.get().replace(" ", "")
            )
        ...
        try:
            batch_normalization_eval = ast.literal_eval(
                self._batch_normalizations_var.get().replace(" ", "")
            )
    ...
    def _build_model(self):
        ...
        self._model.build_model(
            ...
            batch_normalizations=list(
                ast.literal_eval(self._batch_normalizations_var.get())
            ),
...
class TrainCustomRFDialog(CustomTrainDialog):
    ...
    def _initialize(self):
        ...
        Label(self.window, text="Min Samples Leaf", font=("Arial", 10)).place(
            x=20, y=165
        )
        Label(self.window, text="Min Samples Split", font=("Arial", 10)).place(
            x=20, y=225
        )
        ...
        Scale(
            ...
            orient="horizontal",
            length=220,
            variable=self._n_estimators_var,
        ).place(x=300, y=1)
        ...
        max_features_cb = Combobox(
            ...
            font=("Arial", 10),
            state="readonly",
            textvariable=self._max_features_var,
        )
        ...
        max_depth_cb = Combobox(
            ...
            font=("Arial", 10),
            state="readonly",
            textvariable=self._max_depth_var,
        )
        ...
        Scale(
            ...
            orient="horizontal",
            length=220,
            variable=self._min_samples_leaf_var,
        ).place(x=300, y=150)
        ...
        Scale(
            ...
            orient="horizontal",
            length=220,
            variable=self._min_samples_split_var,
        ).place(x=300, y=210)
        ...
        class_weight_cb = Combobox(
            ...
            font=("Arial", 10),
            state="readonly",
            textvariable=self._class_weight_var,
        )
