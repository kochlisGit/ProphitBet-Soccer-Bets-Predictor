...
class PredictionDialog(Dialog):
    def __init__(
        ...
        super().__init__(
            root=root, title="Prediction", window_size={"width": 350, "height": 300}
        )
        ...
        self._results_dict = {0: "H", 1: "D", 2: "A"}
    ...
    def _initialize(self):
        ...
        home_team_cb = Combobox(
            ...
            font=("Arial", 10),
            state="readonly",
            textvariable=self._home_team_var,
        )
        ...
        away_team_cb = Combobox(
            ...
            font=("Arial", 10),
            state="readonly",
            textvariable=self._away_team_var,
        )
        ...
        Button(self.window, text="Predict", command=self._submit_prediction).place(
            x=135, y=250
        )
