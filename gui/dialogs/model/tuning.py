...
class TuningNNDialog(TuningDialog):
    ...
    def _initialize(self):
        ...
        Label(self.window, text="Target to Maximize", font=("Arial", 10)).place(
            x=20, y=110
        )
        ...
        Label(self.window, text="Early Stopping Epochs", font=("Arial", 10)).place(
            x=20, y=275
        )
        Label(self.window, text="Learning Rate Decay Factor", font=("Arial", 10)).place(
            x=20, y=325
        )
        Label(self.window, text="Learning Rate Decay Epochs", font=("Arial", 10)).place(
            x=20, y=385
        )
        ...
        Label(self.window, text="Neuron Increment", font=("Arial", 10)).place(
            x=580, y=385
        )
        ...
        create_tooltip_btn(
            root=self.window, x=720, y=165, text="Minimum number of hidden layers"
        )
        create_tooltip_btn(
            root=self.window, x=720, y=220, text="Maximum number of hidden layers"
        )
        create_tooltip_btn(
            root=self.window, x=720, y=275, text="Minimum number of units (Neurons)"
        )
        create_tooltip_btn(
            root=self.window, x=720, y=325, text="Maximum number of units (Neurons)"
        )
        create_tooltip_btn(
            root=self.window, x=720, y=385, text="Increment of units during each trial"
        )
        ...
        metric_target_cb = Combobox(
            ...
            font=("Arial", 10),
            state="readonly",
            textvariable=self.metric_target_var,
        )
        ...
        Scale(
            ...
            orient="horizontal",
            length=140,
            variable=self._units_increment_var,
        ).place(x=775, y=370)

        self.tune_btn.place(x=490, y=425)

        self._text = scrolledtext.ScrolledText(
            self.window, width=60, height=19, state="disabled"
        )
...
class TuningRFDialog(TuningDialog):
    ...
    def _initialize(self):
        ...
        self._text = scrolledtext.ScrolledText(
            self.window, width=55, height=18, state="disabled"
        )
