...
from models.estimators import DecisionTree


class DecisionTreeTrainDialog(TrainingDialog):
    ...
    def _init_dialog(self):
        self._model_id_var.set(value='decision-tree-model')
    ...
    def _create_widgets(self):
        ...
        max_features_var = StringVar(value='None')
        widget_params = {
        ...
        self._add_tunable_widget(
            ...
            name='Max Features',
            description='Max selected features for tree construction',
            x=150,
            y=400,
            x_pad=15,
            **widget_params
