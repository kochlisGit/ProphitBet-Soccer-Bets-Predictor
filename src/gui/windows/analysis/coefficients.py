...
class CoefficientsAnalyzerWindow(QDialog):
    """ Coefficient analyzer window using logistic regression. """

    def __init__(self, df: pd.DataFrame):
        super().__init__()

        self._analyzer = CoefficientAnalyzer(df=df)
        ...
        self._title = 'Coefficients Analysis'
        self._width = 350
        self._height = 150
