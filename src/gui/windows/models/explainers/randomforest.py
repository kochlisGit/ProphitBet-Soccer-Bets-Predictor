...
class RandomForestExplainerDialog(ExplainerDialog):
    ...
    def _get_explainer(self, model: RandomForest) -> RandomForestExplainer:
        return RandomForestExplainer(model=model, df=self._df)
